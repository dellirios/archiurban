...
import { Search, Bell, ChevronDown, ArrowLeftRight, LogOut } from 'lucide-react';
import { useApp } from '@/contexts/AppContext';
import { tenants } from '@/data/mockData';
import { cn } from '@/lib/utils';

const ArchiTopbar = () => {
  const { currentUser, currentTenant, viewMode, setViewMode, setCurrentTenant, notifications } = useApp();
  ...
  return (
    <header className="h-16 bg-card border-b border-border flex items-center justify-between px-6 gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          <button
            onClick={() => { setShowTenantSelector(!showTenantSelector); setShowNotifications(false); setShowUserMenu(false); }}
        ...
        <div className="relative">
          <button
            onClick={() => { setShowNotifications(!showNotifications); setShowTenantSelector(false); setShowUserMenu(false); }}
        ...
        <div className="relative">
          <button
            onClick={() => { setShowUserMenu(!showUserMenu); setShowNotifications(false); setShowTenantSelector(false); }}
